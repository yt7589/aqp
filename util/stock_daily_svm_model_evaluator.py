...
class StockDailySvmModelEvaluator(object):
    # 1:open, 2:high, 3:low, 4:close, 5:pre_close, 6:amt_chg, 7:pct_chg, 8:vol, 9:amount
    open_idx = 0
    high_idx = 1
    low_idx = 2
    close_idx = 3
    ...
    def get_mean_stds(ts_code, start_dt, end_dt):
        ...
        print('amount: {0}, {1}'.format(mus[StockDailySvmModelEvaluator.amount_idx],
    ...
    def evaluate_model():
        ...
        print('precision:{0}; recall:{1}; f1:{2} tp={3}; fp={4}; fn={5}'.format(precision, recall, f1, tp, fp, fn))